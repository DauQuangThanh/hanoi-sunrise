...
CURSOR_FILE="$REPO_ROOT/.cursor/rules/sunrise-rules.mdc"
QWEN_FILE="$REPO_ROOT/QWEN.md"
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
WINDSURF_FILE="$REPO_ROOT/.windsurf/rules/sunrise-rules.md"
KILOCODE_FILE="$REPO_ROOT/.kilocode/rules/sunrise-rules.md"
AUGGIE_FILE="$REPO_ROOT/.augment/rules/sunrise-rules.md"
ROO_FILE="$REPO_ROOT/.roo/rules/sunrise-rules.md"
...
# Template file
TEMPLATE_FILE="$REPO_ROOT/.sunrise/templates/templates-for-commands/agent-file-template.md"
