...
function Setup-Standardize {
    ...
    $templateFile = Join-Path $repoRoot ".sunrise" "templates" "templates-for-commands" "standards-template.md"
    $groundRulesFile = Join-Path $repoRoot ".sunrise" "memory" "ground-rules.md"
