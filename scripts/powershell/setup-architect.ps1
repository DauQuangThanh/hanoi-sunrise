# setup-architect.ps1 - Setup script for /sunrise.architect command
...
$archTemplate = ".sunrise\templates\templates-for-commands\arch-template.md"
...
if (-not (Test-Path ".sunrise\memory\ground-rules.md")) {
    Write-Error "Ground rules file not found: .sunrise\memory\ground-rules.md. Run /sunrise.set-ground-rules first."
    exit 1
}
...
"@
    ...
    Write-Host "   4. Run feature implementation plans with /sunrise.design"
    Write-Host ""
}
