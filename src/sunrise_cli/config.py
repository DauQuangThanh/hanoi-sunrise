"""Configuration constants and agent definitions for Sunrise CLI."""
...
TAGLINE = "Hanoi Sunrise - Drive Quality Together with Agentic AI"

# GitHub repository information
GITHUB_REPO_OWNER = "dauquangthanh"
GITHUB_REPO_NAME = "hanoi-sunrise"
