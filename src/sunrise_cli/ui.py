"""UI components and interactive elements for Sunrise CLI."""
...
app = typer.Typer(
    name="sunrise",
    help="Setup tool for Sunrise spec-driven development projects",
...
def callback(ctx: typer.Context):
    ...
    if ctx.invoked_subcommand is None and "--help" not in sys.argv and "-h" not in sys.argv:
        show_banner()
        console.print(Align.center("[dim]Run 'sunrise --help' for usage information[/dim]"))
        console.print()
