...
**Note**: This template is filled in by the `/sunrise.design` command.
...
```text
specs/[###-feature]/
├── design.md            # This file (/sunrise.design command output)
├── research.md          # Phase 0 output (/sunrise.design command)
├── data-model.md        # Phase 1 output (/sunrise.design command)
├── quickstart.md        # Phase 1 output (/sunrise.design command)
├── contracts/           # Phase 1 output (/sunrise.design command)
└── tasks.md             # Phase 2 output (/sunrise.taskify command - NOT created by /sunrise.design)
```
