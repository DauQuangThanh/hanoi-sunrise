...
User can sunrise execution mode via arguments:
...
/sunrise.perform-e2e-test

# Run full regression suite
/sunrise.perform-e2e-test regression

# Run complete test suite
/sunrise.perform-e2e-test full

# Run specific scenarios
/sunrise.perform-e2e-test --scenarios=login,checkout,payment

# Run specific priority
/sunrise.perform-e2e-test --priority=P1

# Run with custom configuration
/sunrise.perform-e2e-test smoke --browser=firefox --retries=3 --parallel=4

# Run in headless mode
/sunrise.perform-e2e-test regression --headless

# Generate test scripts only (no execution)
/sunrise.perform-e2e-test --generate-only
```
