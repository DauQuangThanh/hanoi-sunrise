...
handoffs: 
  - label: Clarify Spec Requirements...
    agent: sunrise.clarify
    prompt: Focus on edge cases, data validation, and user experience details...
    send: false
  - label: Build Architecture Design...
    agent: sunrise.architect
    prompt: Create C4 diagrams, document tech stack decisions and architecture patterns. I am building...
    send: false
...
The text the user typed after `/sunrise.specify` in the triggering message **is** the feature description. Assume you always have it available in this conversation even if `{ARGS}` appears literally below. Do not ask the user to repeat it unless they provided an empty command.
...
3. Load `.sunrise/templates/templates-for-commands/spec-template.md` to understand required sections.
...
7. **Specification Quality Validation**: After writing the initial spec, validate it against quality criteria:
   ...
   a. **Create Spec Quality Checklist**: Generate a checklist file at `FEATURE_DIR/checklists/requirements.md` using the checklist template structure with these validation items:
      ...
      **Feature**: [Link to spec.md]
      ...
      - Items marked incomplete require spec updates before `/sunrise.clarify` or `/sunrise.design`
      ```
...
8. Report completion with branch name, spec file path, checklist results, and readiness for the next phase (`/sunrise.clarify` or `/sunrise.architect` or `/sunrise.design`).
