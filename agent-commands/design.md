...
2. **Load context**: Read FEATURE_SPEC, `docs/ground-rules.md`, and `docs/architecture.md` (if it exists). Load FEATURE_DESIGN template (already copied). Adhere to the principles for maximizing system clarity, structural simplicity, and long-term maintainability.
